...
{
    public class AnmeldungUnitTest
    {
        ServiceProvider provider;

        public AnmeldungUnitTest()
        {
            var services = new ServiceCollection();
            services.AddDbContext<ApplicationDbContext>((context) => context.UseInMemoryDatabase("test"));
            services.AddAutoMapper();
            services.AddScoped<IRazorViewToStringRenderer, FakeRazorToStringRenderer>();
            services.AddScoped<ISchulungsportalEmailSender, MockEmailSender>();
            services.AddScoped<MockEmailSender>();
            services.AddScoped<MailingHelper>();
            services.AddScoped<AnmeldungRepository>();
            services.AddScoped<AnmeldungController>();
